...
@safe_telegram_operation(
    "start_command",
    "Sorry, I couldn't process your /start command. Please try again."
)
...
async def handle_regular_conversation(update: Update, message_text: str, user_id: str, chat_id: str) -> None:
...
@safe_telegram_operation(
    ...
    "Sorry, I couldn't process that button. Please try again."
)
...
async def main():
    ...
    logger.info("   OpenServ API: /openserv/do_task, /openserv/respond_chat_message, /openserv/compile_bot")
