...
class APIRouter:
    ...
    def __init__(self, telegram_manager, agno_agent, bot_compilation_queue: dict, completed_bot_specs: dict):
    ...
    async def openserv_main(self, request: Request):
    ...
    async def get_compilation_status(self, compilation_id: str):
    ...
    async def get_available_tools(self):
        ...
        for tool in AVAILABLE_TOOLS:
            ...
            tools_by_category[category].append({
                ...
                "integration_effort": tool.integration_effort.value
            })
    ...
    async def test_openserv_connection(self):
    ...
    async def openserv_ping(self, request: Request):
    ...
    async def openserv_do_task(self, request: OpenServTaskRequest):
    ...
    async def openserv_respond_chat(self, request: OpenServChatRequest):
    ...
    async def test_monitor_dashboard(self):
        """Serve the test monitoring dashboard"""
        return HTMLResponse(content=get_dashboard_html())

    async def test_monitor_websocket(self, websocket: WebSocket):
    ...
    async def get_test_events(self, limit: int = 100, event_type: str | None = None):
